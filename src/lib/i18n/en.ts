...
export const en = {
  ...
  log: {
    ...
    loyalty: {
      ...
      updated: "changed the visit card",
      paused: "switched the visit card off",
      deleted: "took back a stamp",
    },
    staff: {
    ...
    loginRemoved: "Staff login removed",
...
myBill: "View my bill",
    ...
    skipsKitchen: "Does not go to the kitchen",
    skipsKitchenHint: "For things handed over as they are rung up — bottled drinks, packaged snacks. They stay off the kitchen ticket.",
  ...
  bill: {
    ...
    cashOnly: "This restaurant can't take cards from your phone yet. Call a waiter and pay at the table, in cash or on their card reader.",
    dividing: "The table has divided this bill. Everyone pays their share from their own phone, or you can call a waiter.",
    waiterSettles: "Your waiter opened this bill and is settling it at the table. Call them when you are ready to pay.",
  ...
  settle: {
    ...
    parts: "Collect in parts",
    partsTitle: "Table {label} · in parts",
    collected: "Already collected",
    owed: "Still to collect",
    modeFull: "Everything",
    modeSplit: "Equal parts",
    modeAmount: "An amount",
    shareOf: "Part {n} of {of}",
    howMuch: "How much are they paying?",
    collectedOk: "{amount} collected · {left} to go",
    promo: "Apply a promotion",
    cash: "Paid cash",
    card: "Paid by card",
    ...
    loadFailed: "We couldn't load this table's bill, so we can't tell you what it owes. Try again before letting the table go.",
    retry: "Try again",
  },
  cart: {
...
foundingLeftBody: "Subscribe now and keep this price for good. After that the list price applies.",
  ...
  nav: {
    ...
    loyalty: "Visit card",
    loyaltyDesc: "Stamps per visit, and a reward",
    tables: "Tables & QR",
    bills: "Open bills",
  ...
  split: {
    ...
    hintCash: "Evenly, between the people who ordered. Show this to your waiter and they can take each share.",
    each: "{amount} each",
    people: "How many of you?",
    propose: "Split · {each} each",
    asked: "Someone suggested splitting {n} ways",
    waiting: "{joined} of {of} so far",
    join: "Count me in",
    no: "No thanks",
    leave: "Leave it",
    callOff: "Call it off",
  ...
  waiter: {
    ...
    table: "Table",
    scan: "Scan",
    scanTitle: "Scan the table",
    scanHint: "Point the camera at the code on the table.",
    scanElsewhere: "That code belongs to another restaurant.",
    scanUnknown: "That table is not one of yours. Create it first under Tables.",
    scanned: "Table {label}",
  ...
  pos: {
    title: "Till",
    sale: "Sale",
    empty: "Tap a dish to start.",
    total: "Total",
    customerName: "Name (optional)",
    customerNameHint: "To call them when it is ready",
    receiptEmail: "Email for the receipt (optional)",
    receiptEmailHint: "Shall I send the receipt or print it?",
    receiptPrintOnly: "Printing only for now — sending mail is not set up yet.",
    receiptSent: "Receipt sent",
    receiptFailed: "We could not send the receipt — print it instead.",
    search: "Search a dish…",
    sections: "Sections",
    noMatch: "Nothing matches that search.",
    note: "Special request (optional)",
    noteHint: "No onion, to go…",
    ...
    noTicket: "The customer does not want a ticket",
    noTicketHint: "Nothing is printed and nothing is emailed. The sale is recorded either way.",
    handedOver: "Handed over. Nothing to wait for.",
    finishSale: "Finish the sale",
    calledOut: "On the pass. Call them when it is ready.",
    chargeCash: "Charge cash",
    chargeCard: "Charge card",
    charged: "Charged",
    newSale: "New sale",
    closedNow: "No menu is serving at this hour.",
    outOfStock: "None left: {names}. Adjust the sale before charging.",
    leftCount: "{n} left",
    shortIntro: "Not enough: {list}. Adjust the sale before charging.",
    shortSome: "{name} (only {n} left)",
    shortNone: "{name} (none left)",
    addToSale: "Add",
  ...
  apiErr: {
    ...
    splitAlready: "This table is already dividing its bill.",
    ...
    printerTokenFailed: "Could not create the printer address. Please try again.",
    settingNotAllowed: "You can't change that setting.",
    noPrinter: "No kitchen printer is set up yet. Add one in Settings.",
    ...
    loyaltyPlan: "Your plan doesn't include the visit card.",
    loyaltyGoal: "Visits have to be a whole number between {min} and {max}.",
    loyaltySteps: "A card can have up to {max} rewards.",
    loyaltyStepsRepeat: "Two rewards can't ask for the same number of visits.",
    loyaltyStepReward: "Write each reward, or remove the one you don't need.",
    loyaltyReward: "Keep the reward to {max} characters.",
  ...
  dash: {
    partlyPaid: "{amount} already in",
    splitting: "Splitting · {paid} of {of} paid · {amount} in",
    printingTitle: "Kitchen printer",
    autoPrintLabel: "Print orders automatically",
    autoPrintHint: "Every order that reaches the pass is printed in the kitchen.",
    printerUrlLabel: "Printer address",
    printerUrlNone: "No address yet. Create one and enter it in the printer's CloudPRNT settings.",
    printerUrlHidden: "Already set up. Creating a new address stops the old one working.",
    printerUrlCreate: "Create the address",
    printerUrlRotate: "Create a new address",
    printerUrlRotateHint: "Use this if the address has been seen by somebody who should not have it. The printer has to be set up again with the new one.",
    printerUrlCopyHint: "Copy this into the printer's CloudPRNT server URL. It is shown once.",
    printerUrlIssued: "Address created",
...
stillOpen: "Other open bills",
    ...
    billCodesFailed: "Couldn't load the promotions. You can still type the code.",
...
badgesHint: "Shows how many things are waiting in each section. Applies to the whole team.",
    ...
    splitTitle: "Split the bill at the table",
    splitHint: "Let a table divide its bill evenly between the people who ordered. With Stripe connected each of them pays their own share; without it, it is the division they show the waiter.",
  ...
  orders: {
    ...
    printKitchen: "Print in the kitchen",
    printReceipt: "Print the ticket",
    sentToKitchen: "Sent to the kitchen printer",
    historySearch: "Search by code (ORD-1960), table or name…",
  ...
  analytics: {
    loyaltyTitle: "Visit card",
    loyaltyHint: "Over the same period as the charts above.",
    loyaltyCards: "Cards made",
    loyaltyVisits: "Visits stamped",
    loyaltyBack: "Cards that came back",
    loyaltyRewards: "Rewards redeemed",
    loyaltyByStaff: "Stamps by person",
    loyaltyNone: "No visits stamped in this period.",
    revenue: "Revenue",
    orders: "Orders",
...
votes: "Votes",
  ...
  /** /rewards — a diner checking their visit card by its code. */
  rewards: {
    title: "Your visit card",
    intro: "Type the code printed on your card to see your visits.",
    codeLabel: "Card code",
    check: "Show my card",
    checking: "Looking…",
    invalid: "That doesn't look like a card code — it has 12 letters and numbers.",
    notFound: "We couldn't find that card. Check the code printed on it.",
    visitsOf: "{visits} of {goal} visits",
    toGo: "{n} more for: {reward}",
    toGoOne: "1 more for: {reward}",
    toGoNoReward: "{n} more to your reward",
    toGoOneNoReward: "1 more to your reward",
    ready: "Your reward is ready!",
    readyHint: "Show your card to the staff to redeem: {reward}",
    readyHintNoReward: "Show your card to the staff to redeem it.",
    paused: "This restaurant has paused its visit card: no new visits are being added. A reward you already earned is still yours.",
    lastVisit: "Last visit: {date}",
    memberSince: "Card since {date}",
  ...
  loyaltyAdmin: {
    ...
    goalHint: "Changing the rewards doesn't move the finish line on cards already on their way: they take the new ones when their round ends.",
    rewardLabel: "Reward",
    rewardPlaceholder: "Free dessert",
    save: "Save",
    saving: "Saving…",
    saved: "Visit card saved",
    lookupTitle: "Look up a card",
    lookupHint: "Scan the QR on a diner's card or type its code to see every visit, who stamped it and the rewards spent.",
    lookup: "Look up",
    visits: "Visits",
    undo: "Take back",
    undoTitle: "Take back this stamp?",
    undoBody: "Only today's stamps can be taken back, and it is written in the activity log.",
    undone: "Stamp taken back",
    offTitle: "The visit card is switched off",
    offBody: "Diners aren't offered it and your team can't stamp it. A reward a diner already earned can still be redeemed: look the card up below. To start again, write the reward, switch the card on and save.",
    onTitle: "The visit card is on",
    onBody: "Diners are offered it when they pay. Your team stamps it with “Stamp a card” in Open bills, at the Till, or right here.",
    roundHint: "Each reward is redeemed once per round, in order. Redeeming the last one ends the round, and extra visits carry into the next. The card and its code never reset.",
    stepsLabel: "Rewards",
    stepsHint: "Up to 4, each earned at its number of visits — for example 4 = coffee, 8 = dessert, 12 = a meal.",
    stepVisits: "Visits",
    stepVisitsLabel: "Visits for reward {n}",
    stepRewardLabel: "Reward {n}",
    removeStep: "Remove reward {n}",
    addStep: "Add a reward",
    previewTitle: "What your diners get",
    previewHint: "A picture they save on their phone. The QR and code here are samples.",
    scan: "Scan",
    scanning: "Point the camera at the card's QR.",
  ...
  loyaltyOffer: {
    ...
    body: "{rewards}. Your card is an image you keep on your phone — no sign-up, no name, no email.",
    create: "Get my card",
    creating: "Making your card…",
    dontAsk: "Don't ask again",
    notNow: "Not now",
    ready: "Your card is ready",
    saveHint: "Save the image and show it on each visit, or say the code printed on it.",
    download: "Download my card",
    iosHint: "On an iPhone, press and hold the picture to save it to Photos.",
    checkLater: "Check your progress any time",
    drawFailed: "Your phone couldn't draw the picture. Write down your code: {code}",
    fileName: "visit-card",
    cardAlt: "Your visit card, code {code}",
    cardTitle: "Visit card",
    cardReward: "{goal} visits = {reward}",
    cardGoal: "{goal} visits earn a reward",
    cardShow: "Show this card on each visit",
    cardCheck: "Check your progress at {site}",
    downloadAgain: "Save my card again",
    forget: "Delete my card",
    forgetTitle: "Delete this card?",
    forgetBody: "Its visits and rewards are deleted too, and it can't be undone. Staff won't be able to stamp it again.",
    forgotten: "Your card was deleted.",
  },

  ladder: {
    title: "Rewards on this card",
    visits: "{n} visits",
    noReward: "Reward",
    done: "Redeemed",
    ready: "Ready",
