...
foundingLeftBody: "Subscribe now and keep this price for good. After that the list price applies.",
  ...
  apiErr: {
    ...
    loyaltyGoal: "The goal has to be a whole number of visits between {min} and {max}.",
...
votes: "Votes",
  ...
  loyaltyAdmin: {
    ...
    programHint: "Your team stamps a diner's card with «Stamp a card» on Open bills and at the till — once a day per card. When the card reaches the goal, the reward is redeemed right there.",
    activeLabel: "Visit card on",
    goalLabel: "Visits to earn the reward",
    goalHint: "Changing the goal doesn't move the finish line on cards already on their way: they take the new goal after their next reward.",
    rewardLabel: "Reward",
    ...
    roundHint: "When a card reaches the goal, the reward is redeemed and extra visits carry into the next round. The card and its code never reset.",
