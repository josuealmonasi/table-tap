...
foundingLeftBody: "Quien contrata ahora se queda con este precio para siempre. Después aplica el precio de lista.",
  ...
  apiErr: {
    ...
    loyaltyGoal: "La meta tiene que ser un número entero de visitas entre {min} y {max}.",
...
votes: "Votos",
  ...
  loyaltyAdmin: {
    ...
    programHint: "Tu equipo sella la tarjeta de un cliente con «Sellar tarjeta» en Cuentas y en la caja, una vez al día por tarjeta. Cuando la tarjeta llega a la meta, la recompensa se canjea ahí mismo.",
    activeLabel: "Tarjeta de visitas activa",
    goalLabel: "Visitas para ganar la recompensa",
    goalHint: "Cambiar la meta no mueve la meta de las tarjetas que ya van en camino: toman la nueva después de su siguiente recompensa.",
    ...
    roundHint: "Al llegar a la meta, la recompensa se canjea y las visitas de más pasan a la siguiente ronda. La tarjeta y su código nunca se reinician.",
