...
export const es: Messages = {
  ...
  log: {
    ...
    loyalty: {
      ...
      updated: "cambió la tarjeta de visitas",
      paused: "apagó la tarjeta de visitas",
      deleted: "quitó un sello",
    },
    staff: {
  ...
  menu: {
    stock: "Existencias",
    stockHint: "Vacío: lo maneja el interruptor. Con número: se descuenta y sale de la carta al llegar a cero.",
    stockLocked: "Contar existencias viene con los planes de paga.",
...
myBill: "Ver mi cuenta",
    ...
    skipsKitchen: "No pasa por cocina",
    skipsKitchenHint: "Para lo que se entrega en el momento: bebidas embotelladas, productos empacados. No aparecen en el ticket de cocina.",
  ...
  corte: {
    title: "Corte de caja",
    hint: "Lo cobrado hoy, por persona. El efectivo es lo que debe estar en el cajón.",
    empty: "Todavía no se ha cobrado nada hoy.",
    print: "Imprimir",
    who: "Quién cobró",
    count: "Cobros",
    total: "Total",
  ...
  till: {
    title: "Lo que llevas cobrado",
    hint: "Sólo lo tuyo, desde que abrió el día",
    empty: "Todavía no has cobrado nada hoy.",
    count: "{n} cobro(s)",
    cash: "Efectivo",
    card: "Tarjeta",
  },
  bill: {
    ...
    cashOnly: "Este restaurante todavía no cobra con tarjeta desde el celular. Llama a un mesero y paga en la mesa, en efectivo o con su terminal.",
    dividing: "La mesa está dividiendo esta cuenta. Cada quien paga su parte desde su celular, o pueden llamar a un mesero.",
    waiterSettles: "Tu mesero abrió esta cuenta y la cobra en la mesa. Llámalo cuando quieras pagar.",
  ...
  settle: {
    ...
    parts: "Cobrar por partes",
    partsTitle: "Mesa {label} · por partes",
    collected: "Ya cobrado",
    owed: "Falta por cobrar",
    modeFull: "Todo",
    modeSplit: "Partes iguales",
    modeAmount: "Un monto",
    shareOf: "Parte {n} de {of}",
    howMuch: "¿Cuánto van a pagar?",
    collectedOk: "{amount} cobrado · faltan {left}",
    promo: "Aplicar promoción",
    ...
    loadFailed: "No se pudo cargar la cuenta de esta mesa, así que no sabemos cuánto debe. Inténtalo de nuevo antes de dejar ir a la mesa.",
  ...
  cart: {
    ...
    soldOut: "Agotado",
    promoNudge: "Lleva {qty} más y ahorra {amount}",
...
foundingLeftBody: "Quien contrata ahora se queda con este precio para siempre. Después aplica el precio de lista.",
    ...
    tier: {
      deferredPayment: "Pagar al final o en la caja",
      ...
      inventory: "Existencias y avisos de inventario",
  ...
  notif: {
    ...
    open: "Notificaciones",
    empty: "Todavía no hay nada que contarte.",
  ...
  nav: {
    ...
    loyalty: "Lealtad",
    loyaltyDesc: "Sellos por visita y una recompensa",
    tables: "Mesas y QR",
  ...
  split: {
    ...
    hintCash: "En partes iguales, entre quienes pidieron. Muéstrale esto al mesero y que cobre a cada quien lo suyo.",
    each: "{amount} cada uno",
    people: "¿Cuántos son?",
    propose: "Dividir · {each} c/u",
    asked: "Alguien propuso dividir entre {n}",
    waiting: "Van {joined} de {of}",
    join: "Me uno",
    no: "No, gracias",
    leave: "Salirme",
    callOff: "Cancelar",
  ...
  // What a thermal printer puts on paper in the kitchen.
  ticket: {
    table: "Mesa {label}",
    counter: "Mostrador",
  ...
  waiter: {
    ...
    table: "Mesa",
    scan: "Escanear",
    scanTitle: "Escanea la mesa",
    scanHint: "Apunta la cámara al código que está en la mesa.",
    scanElsewhere: "Ese código es de otro restaurante.",
    scanUnknown: "Esa mesa no es tuya. Créala primero en Mesas.",
    scanned: "Mesa {label}",
  ...
  pos: {
    title: "Caja",
    sale: "Venta",
    empty: "Toca un platillo para empezar.",
    total: "Total",
    customerName: "Nombre (opcional)",
    customerNameHint: "Para llamarlo cuando esté listo",
    receiptEmail: "Correo para el recibo (opcional)",
    receiptEmailHint: "¿Le mando el recibo o se lo imprimo?",
    receiptPrintOnly: "Por ahora sólo se imprime: el envío de correos aún no está configurado.",
    receiptSent: "Recibo enviado",
    receiptFailed: "No pudimos enviar el recibo — imprímelo.",
    search: "Buscar un platillo…",
    sections: "Secciones",
    noMatch: "Nada coincide con esa búsqueda.",
    note: "Petición especial (opcional)",
    noteHint: "Sin cebolla, para llevar…",
    ...
    noTicket: "El cliente no quiere ticket",
    noTicketHint: "No se imprime ni se envía nada. La venta queda registrada igual.",
    handedOver: "Entregado. No hay nada que esperar.",
    finishSale: "Terminar la venta",
    calledOut: "En la cocina. Llama al cliente cuando esté listo.",
    chargeCash: "Cobrar en efectivo",
    chargeCard: "Cobrar con tarjeta",
    charged: "Cobrado",
    newSale: "Nueva venta",
    closedNow: "Ningún menú está en servicio a esta hora.",
    outOfStock: "Ya no queda: {names}. Ajusta la venta antes de cobrar.",
    leftCount: "quedan {n}",
    shortIntro: "No alcanza: {list}. Ajusta la venta antes de cobrar.",
    shortSome: "{name} (sólo quedan {n})",
    shortNone: "{name} (ya no queda)",
    addToSale: "Agregar",
  ...
  apiErr: {
    ...
    tooManyProducts: "Ese pedido nombra demasiados productos distintos (el máximo es {n}). Divídelo en dos.",
    ...
    splitAlready: "Ya hay una división en curso en esta mesa.",
    ...
    printerTokenFailed: "No se pudo crear la dirección de la impresora. Inténtalo de nuevo.",
    settingNotAllowed: "No puedes cambiar ese ajuste.",
    noPrinter: "Todavía no hay impresora de cocina. Configúrala en Ajustes.",
    ...
    loyaltyPlan: "Tu plan no incluye la tarjeta de visitas.",
    loyaltyGoal: "Las visitas tienen que ser un número entero entre {min} y {max}.",
    loyaltySteps: "La tarjeta puede tener hasta {max} recompensas.",
    loyaltyStepsRepeat: "Dos recompensas no pueden pedir el mismo número de visitas.",
    loyaltyStepReward: "Escribe cada recompensa, o quita la que sobra.",
    loyaltyReward: "La recompensa puede tener hasta {max} caracteres.",
  ...
  dash: {
    partlyPaid: "{amount} ya cobrado",
    splitting: "Dividiendo · {paid} de {of} pagadas · {amount} recibido",
    printingTitle: "Impresora de cocina",
    autoPrintLabel: "Imprimir los pedidos automáticamente",
    autoPrintHint: "Cada pedido que llega a la barra se imprime en la cocina.",
    printerUrlLabel: "Dirección de la impresora",
    printerUrlNone: "Todavía no hay dirección. Crea una y captúrala en la configuración CloudPRNT de la impresora.",
    printerUrlHidden: "Ya está configurada. Si creas una dirección nueva, la anterior deja de funcionar.",
    printerUrlCreate: "Crear la dirección",
    printerUrlRotate: "Crear una dirección nueva",
    printerUrlRotateHint: "Úsalo si la dirección quedó a la vista de alguien que no debería tenerla. Hay que volver a configurar la impresora con la nueva.",
    printerUrlCopyHint: "Cópiala en el campo de servidor CloudPRNT de la impresora. Se muestra una sola vez.",
    printerUrlIssued: "Dirección creada",
    stockAlertsTitle: "Avisos de inventario bajo",
    stockAlertsHint: "Te avisa a ti y a tus gerentes cuando un platillo se está acabando. Sólo cuenta los platillos a los que les pusiste existencias.",
    stockThreshold: "Avísame en",
    stockThresholdHint: "Una notificación cuando un platillo baje a esta cantidad o menos. No se repite hasta que lo vuelvas a surtir.",
    stockUnits: "piezas restantes",
    ...
    noPaymentAtAll: "Ahora mismo nadie puede ordenar: no hay cuenta de Stripe conectada y «Pagar al final / en la caja» está apagado. Conecta Stripe o enciende ese interruptor.",
...
stillOpen: "Otras cuentas abiertas",
    ...
    billCodesFailed: "No se pudieron cargar las promociones. Puedes escribir el código.",
...
badgesHint: "Muestra cuántas cosas esperan acción en cada sección. Aplica a todo el equipo.",
    payLaterTitle: "Pagar al final / en la caja",
    splitTitle: "Dividir la cuenta en la mesa",
    splitHint: "Deja que la mesa reparta su cuenta en partes iguales entre quienes pidieron. Con Stripe conectado cada quien paga la suya; sin él, es la división que le muestran al mesero.",
    payLaterHint: "La comida va a la cocina antes de pagarse. Desde una mesa, la cuenta queda abierta y se cobra al final; desde el QR general, el cliente pasa a la caja con su código. Su pedido llega al tablero marcado como no pagado: no lo entregues sin cobrar.",
    stockAlertsLocked: "Viene con los planes de paga, junto con contar existencias.",
    payLaterLocked: "Viene con los planes de paga. En el plan gratuito se cobra con tarjeta al ordenar — que es de donde sale nuestra comisión.",
  ...
  orders: {
    ...
    printKitchen: "Imprimir en cocina",
    printReceipt: "Imprimir ticket",
    sentToKitchen: "Enviado a la impresora de cocina",
    historySearch: "Busca por código (ORD-1960), mesa o nombre…",
    ...
    terminalCancelMsg: "Se pagaron {amount} con tarjeta en tu propia terminal. La app no puede revertir ese cobro — anúlalo en la terminal.",
    withTableCancelMsg: "Se pagaron {amount} como parte de la cuenta de la mesa, así que no corresponden a una sola tarjeta ni a una sola caja. Devuélvelo tú a la mesa.",
    cancelHandBack: "Cancelar y devolverlo",
    cancelledHandBack: "Pedido cancelado — devuelve {amount} si aún no lo has hecho",
  ...
  analytics: {
    loyaltyTitle: "Tarjeta de visitas",
    loyaltyHint: "En el mismo periodo que las gráficas de arriba.",
    loyaltyCards: "Tarjetas creadas",
    loyaltyVisits: "Visitas selladas",
    loyaltyBack: "Tarjetas que volvieron",
    loyaltyRewards: "Recompensas canjeadas",
    loyaltyByStaff: "Sellos por persona",
    loyaltyNone: "No se sellaron visitas en este periodo.",
    revenue: "Ingresos",
    orders: "Pedidos",
...
votes: "Votos",
  ...
  rewards: {
    title: "Tu tarjeta de visitas",
    intro: "Escribe el código impreso en tu tarjeta para ver tus visitas.",
    codeLabel: "Código de la tarjeta",
    check: "Ver mi tarjeta",
    checking: "Buscando…",
    invalid: "Eso no parece un código de tarjeta: tiene 12 letras y números.",
    notFound: "No encontramos esa tarjeta. Revisa el código impreso en ella.",
    visitsOf: "{visits} de {goal} visitas",
    toGo: "Te faltan {n} para: {reward}",
    toGoOne: "Te falta 1 para: {reward}",
    toGoNoReward: "Te faltan {n} para tu recompensa",
    toGoOneNoReward: "Te falta 1 para tu recompensa",
    ready: "¡Tu recompensa está lista!",
    readyHint: "Muestra tu tarjeta al personal para canjear: {reward}",
    readyHintNoReward: "Muestra tu tarjeta al personal para canjearla.",
    paused: "Este restaurante pausó su tarjeta de visitas: por ahora no se suman visitas. Si ya ganaste tu recompensa, sigue siendo tuya.",
    lastVisit: "Última visita: {date}",
    memberSince: "Tarjeta desde el {date}",
  ...
  loyaltyAdmin: {
    ...
    goalHint: "Cambiar las recompensas no mueve la meta de las tarjetas que ya van en camino: toman las nuevas cuando terminan su ronda.",
    rewardLabel: "Recompensa",
    rewardPlaceholder: "Postre gratis",
    save: "Guardar",
    saving: "Guardando…",
    saved: "Tarjeta de visitas guardada",
    lookupTitle: "Buscar una tarjeta",
    lookupHint: "Escanea el QR de la tarjeta de un cliente o escribe su código para ver cada visita, quién la selló y las recompensas canjeadas.",
    lookup: "Buscar",
    visits: "Visitas",
    undo: "Quitar",
    undoTitle: "¿Quitar este sello?",
    undoBody: "Solo se pueden quitar los sellos de hoy, y queda registrado en la actividad.",
    undone: "Sello quitado",
    offTitle: "La tarjeta de visitas está apagada",
    offBody: "Tus clientes no la ven y tu equipo no puede sellar. Una recompensa que un cliente ya ganó se sigue canjeando: búscala aquí abajo. Para reanudar, escribe la recompensa, activa la tarjeta y guarda.",
    onTitle: "La tarjeta de visitas está activa",
    onBody: "Tus clientes la reciben al pagar. Tu equipo la sella con «Sellar tarjeta» en Cuentas abiertas, en Caja o aquí mismo.",
    roundHint: "Cada recompensa se canjea una vez por ronda, en orden. Al canjear la última, la ronda termina y las visitas de más pasan a la siguiente. La tarjeta y su código nunca se reinician.",
    stepsLabel: "Recompensas",
    stepsHint: "Hasta 4, cada una al llegar a su número de visitas: por ejemplo 4 = café, 8 = postre, 12 = comida.",
    stepVisits: "Visitas",
    stepVisitsLabel: "Visitas para la recompensa {n}",
    stepRewardLabel: "Recompensa {n}",
    removeStep: "Quitar la recompensa {n}",
    addStep: "Añadir recompensa",
    previewTitle: "Así la ven tus clientes",
    previewHint: "Una imagen que guardan en su teléfono. El QR y el código son de ejemplo.",
    scan: "Escanear",
  ...
  loyaltyOffer: {
    ...
    body: "{rewards}. Tu tarjeta es una imagen que guardas en tu teléfono: sin registro, sin nombre y sin correo.",
    create: "Crear mi tarjeta",
    creating: "Creando tu tarjeta…",
    dontAsk: "No volver a preguntar",
    notNow: "Ahora no",
    ready: "Tu tarjeta está lista",
    saveHint: "Guarda la imagen y muéstrala en cada visita, o di el código que trae impreso.",
    download: "Descargar mi tarjeta",
    iosHint: "En iPhone, mantén presionada la imagen para guardarla en Fotos.",
    checkLater: "Consulta tu avance cuando quieras",
    drawFailed: "Tu teléfono no pudo dibujar la imagen. Anota tu código: {code}",
    fileName: "tarjeta-de-visitas",
    cardAlt: "Tu tarjeta de visitas, código {code}",
    cardTitle: "Tarjeta de visitas",
    cardReward: "{goal} visitas = {reward}",
    cardGoal: "{goal} visitas ganan una recompensa",
    cardShow: "Muestra esta tarjeta en cada visita",
    cardCheck: "Consulta tu avance en {site}",
    downloadAgain: "Guardar mi tarjeta otra vez",
    forget: "Borrar mi tarjeta",
    forgetTitle: "¿Borrar esta tarjeta?",
    forgetBody: "Sus visitas y recompensas también se borran, y no se puede deshacer. El personal ya no podrá sellarla.",
    forgotten: "Tu tarjeta se borró.",
  },
  ladder: {
    title: "Recompensas de esta tarjeta",
    visits: "{n} visitas",
    noReward: "Recompensa",
    done: "Canjeada",
    ready: "Lista",
